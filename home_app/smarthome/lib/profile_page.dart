...
// ✅ Target Page
class upload_imge_faceregression extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Face Recognition")),
      body: const Center(child: Text("Upload Image for Face Recognition")),
    );
  }
}
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ? const Center(child: CircularProgressIndicator(color: Color(0xFF2879fe)))
                      ...
                      children: [
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ProfileItem(icon: Icons.person, title: "Name", value: widget.userData['fullName'] ?? username),
                                Divider(thickness: 1, color: Colors.grey[800]),
                                ProfileItem(icon: Icons.email, title: "Email", value: widget.userData['email'] ?? email),
                                Divider(thickness: 1, color: Colors.grey[800]),
                                ProfileItem(icon: Icons.phone, title: "Phone", value: widget.userData['phone'] ?? "Add phone number"),
                                Divider(thickness: 1, color: Colors.grey[800]),
                                ProfileItem(icon: Icons.lock, title: "Password", value: "Change", isAction: true),
                                Divider(thickness: 1, color: Colors.grey[800]),
                                ProfileItem(
                                  icon: Icons.lock,
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => FaceUploadScreen()),
                                    );
                                  },
                                ),
                              ],
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: const [
                                ProfileItem(icon: Icons.notifications, title: "Notifications", value: "On", isAction: true),
                                Divider(thickness: 1, color: Color.fromARGB(255, 66, 66, 66)),
                                ProfileItem(icon: Icons.language, title: "Language", value: "English", isAction: true),
                                Divider(thickness: 1, color: Color.fromARGB(255, 73, 72, 72)),
                                ProfileItem(icon: Icons.dark_mode, title: "Dark Mode", value: "On", isAction: true),
                              ],
                            ),
                          ),
                        ),
                        ...
                        onPressed: () async {
                          ...
                          if (updatedData != null) {
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    ProfilePage(userData: Map<String, String?>.from(updatedData)),
                              ),
                            );
                          }
                        },
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          title: const Text("Logout", style: TextStyle(color: Color(0xFFEEEEEE))),
                          ...
                          actions: [
                            ...
                            ElevatedButton(
                              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF2879fe)),
                              onPressed: () {
...
// ✅ Fixed ProfileItem to support onTap
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, color: const Color(0xFF2879fe), size: 22),
            ...
            isAction
                ? Row(
                    children: [
                      Text(value, style: const TextStyle(fontSize: 16, color: Color(0xFF2879fe))),
